...
st.set_page_config(
    page_title="11796 - Unsupervised Learning",
    page_icon="📊",
    layout="wide",
...
if uploaded_file is not None:
    ...
    st.markdown("<h1 style='text-align:center;'>Unsupervised Learning - KEVIN </h1>", unsafe_allow_html=True)
    st.dataframe(input_data)

    model_directory = r'D:\Nicolaus Kevin PH\SEMS 5\ML\Pert 10\Unsupervised Learning (Praktek)\Tugas4_A_11796'
    model_path = {
